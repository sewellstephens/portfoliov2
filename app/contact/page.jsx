...
<p className='mt-2'>X: <a href="https://twitter.com/sewell_stephens" className="underline text-gray-900 hover:text-gray-500">@sewell_stephens</a></p>
<p className='mt-2'>Github: <a href="https://github.com/sewellstephens" className='underline text-gray-900 hover:text-gray-500'>@sewellstephens</a></p>
</div>
      </div>
  )
}