...
export default function Header() {
    return (
        <div>
            <Link href="/"><Image src="/new-pic-2.jpg" className="rounded-full mt-4" alt="pic" width={70} height={70} /></Link>
            <h1 className="text-lg mt-4 text-gray-900">Sewell Stephens</h1>
            <p className="text-sm text-gray-900">Founder of <a href="https://www.krastie.ai" className="underline hover:text-gray-500 text-gray-900">Krastie AI</a></p>
